...
public class HoaDonChiTietAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txtMaMonAn.setText("Mã món: " + _entry.getMonAn().getMaMonAn());
        holder.txtSoLuong.setText("Số lượng: " + _entry.getSoLuongMua());
        holder.txtGiaBan.setText("Giá bán: " + _entry.getMonAn().getGiaBan() + " vnd");
        holder.txtThanhTien.setText("Thành tiền: " + _entry.getSoLuongMua() * _entry.getMonAn().getGiaBan() + " vnd");
        return convertView;
    }
