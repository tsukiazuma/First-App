...
public class TheLoaiActivity extends AppCompatActivity {
    ...
    EditText edMa, edTen, edDiaDiem, edMoTa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edDiaDiem = findViewById(R.id.edVi);
        edMoTa = findViewById(R.id.edMo);
    ...
    public void themtheloai(View view) {
        ...
        TheLoai user = new TheLoai(edMa.getText().toString(), edTen.getText().toString(), edMoTa.getText().toString(), edDiaDiem.getText().toString());
        try {
            if (validateForm() > 0) {
    ...
    public int validateForm() {
        ...
        if (edMa.getText().length() == 0 || edTen.getText().length() == 0
                || edDiaDiem.getText().length() == 0 || edMoTa.getText().length() == 0) {
